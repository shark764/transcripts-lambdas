...
exports.handler = async (event) => {
  ...
  try {
    ...
    const data = await fetchMessagingArtifactFile(artifact);
    ...
    const errMsg = dne ? 'Specified interaction transcript does not exist' : 'An unexpected error occurred fetching media transcript';
